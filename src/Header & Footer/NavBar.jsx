...
const NavBar = () => {
    ...
    return (
            ...
            <div className="navbar bg-black pt-10 md:pt-6 fixed z-10 bg-opacity-10 max-w-screen-xl pb-0 ">
                <div className="navbar-start">
                    <div className="dropdown">
                        <label tabIndex={0} className="btn btn-ghost lg:hidden">
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 6h16M4 12h8m-8 6h16" /></svg>
                        </label>
                        <ul tabIndex={0} className=" menu menu-compact dropdown-content mt-3 p-2 shadow bg-rose-700 rounded-box w-52 text-black">
                            {navTool}
                        </ul>
                    </div>
                    <a className="btn btn-ghost  text-4xl font-bold text-black font-mono">
                        MELODY<GiMusicalKeyboard></GiMusicalKeyboard>LAB<span className='text-3xl font-extrabold'>.</span>
                    </a>
                </div>
                <div className="navbar hidden lg:flex text-black">
